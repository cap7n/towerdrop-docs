...
- <span class="pill todo">Todo</span> **→ 0.10** Exclude test scenes (`vfx_bench`, `enemy_bench`, `cart_test`) from the player flow (export filter already excludes them).
