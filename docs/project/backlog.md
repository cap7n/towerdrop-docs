...
- [ ] **BUG: lure(?) dropped a clump of climbers who sat "stuck but alive" at the tower base.** Suspects: the lure pin not releasing, or knocked-off climbers failing to re-path/re-climb after landing. Needs a live repro (lure a mid-wall clump, watch them land).
